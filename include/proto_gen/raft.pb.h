...
#ifndef PROTOBUF_protos_2fraft_2eproto__INCLUDED
#define PROTOBUF_protos_2fraft_2eproto__INCLUDED
...
class vote_request : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:raft.vote_request) */ {
 ...
 private:
  ...
  friend struct protobuf_protos_2fraft_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
inline void install_snapshot_request::set_data(const void* value, size_t size) {
...
#endif  // PROTOBUF_protos_2fraft_2eproto__INCLUDED
