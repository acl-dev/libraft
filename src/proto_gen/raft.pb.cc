...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  ...
  { 10, -1, sizeof(vote_response)},
  { 19, -1, sizeof(log_entry)},
  { 28, -1, sizeof(replicate_log_entries_request)},
  { 40, -1, sizeof(replicate_log_entries_response)},
  { 49, -1, sizeof(snapshot_info)},
  { 56, -1, sizeof(install_snapshot_request)},
  { 68, -1, sizeof(install_snapshot_response)},
};
  ...
  for (unsigned int i = 0, n = this->entries_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        7, this->entries(i), deterministic, target);
  }
...
::google::protobuf::uint8* install_snapshot_request::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_snapshot_info()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        3, *this->snapshot_info_, deterministic, target);
  }
